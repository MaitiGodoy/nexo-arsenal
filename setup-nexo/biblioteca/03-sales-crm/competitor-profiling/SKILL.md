...
## Referência
`REFERENCE.md` (nesta pasta) tem o **método detalhado de pesquisa**: categorias de
concorrente, técnicas de descoberta, coleta automatizada, comparação de pricing,
matriz de features, análise de SEO e presença social. Consulte quando precisar do
passo a passo de coleta — os princípios e o formato de saída estão aqui no SKILL.md.
