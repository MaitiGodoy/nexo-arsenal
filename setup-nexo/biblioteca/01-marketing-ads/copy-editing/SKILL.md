...
Camada estratégica acima desta skill. **Não compulsória.** Em revisão simples (typos, frases truncadas), skill roda sozinha. Em revisão estrutural, ou quando o usuário pedir "use o Cérebro" / "aplique Cérebro N/M/P", ler **antes** de revisar.
...
- `09-bullets-e-tecnicas-de-frase.md` — microcopy, ratio 7:1, especificidade, palavras magnéticas
- `11-anti-padroes.md` — **gate principal de revisão** — 25 anti-padrões + checklist pré-publicação
