...
## Referência
Para **escolha de tipo de gráfico**, **acessibilidade** (daltonismo, contraste) e
**padrões de código Python** (matplotlib/seaborn/plotly), consulte `REFERENCE.md`
nesta pasta. Carregue só quando precisar decidir o tipo de chart ou aplicar
design/acessibilidade — o workflow acima resolve o caso comum sem ele.
