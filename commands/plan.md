---
description: Diagnóstico + PLANO por fases atômicas — orquestra as skills que decidem o plano
argument-hint: <descrição da tarefa>
---

Você está no modo ARQUITETO. O plano que você gera será executado depois
...
(Renomeado de `/ultraplan` em 2026-08-08 — nem todo harness usa esse verbo.)
