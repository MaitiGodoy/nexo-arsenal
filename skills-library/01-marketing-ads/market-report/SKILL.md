---
name: market-report
description: Relatório de marketing em Markdown a partir de dados/análises prévias do cliente. Estrutura padrão pronta pra apresentação. Trigger: '/market report <input>' ou 'monta relatório de marketing'.
---
...
## Saída em PDF
Se o usuário pedir **PDF** (não Markdown), consulte `REFERENCE-PDF.md` nesta pasta:
pipeline Pandoc, design system MktOps, capa, sumário, esquema de cores e página de
metodologia. O relatório em si é o mesmo — muda só a camada de renderização.
