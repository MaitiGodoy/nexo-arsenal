---
name: market-landing
description: Análise CRO de landing page — diagnóstico das 5 dimensões (clareza, motivação, fricção, confiança, prova social) + recomendações com lift estimado. Trigger: '/market landing <url>' ou 'analisa essa landing page'.
---
