---
name: market-brand
description: Análise de brand voice e geração de guidelines a partir de URL — tom, vocabulário, estilo, do's/don'ts, frases-âncora. Trigger: '/market brand <url>', 'analisa voz da marca' ou 'gera brand guidelines'.
---
