...
Camada estratégica acima desta skill. **Não compulsória.** Em sequência simples, skill roda sozinha. Em autoresponder longo (12-94 emails), lançamento estruturado ou quando o usuário pedir "use o Cérebro" / "aplique Cérebro N/M/P", ler **antes** de gerar.
...
- `03-hooks-e-aberturas.md` — 6 fórmulas de subject line testadas Settle
- `04-bridges-e-transicoes.md` — 14 bridges Harris + transições
- `06-closes-e-ctas.md` — 10 CTAs Settle + closes nomeados
- `07-emails-e-sequencias.md` — 5 pilares Orzechowski, autoresponder/broadcast/launch, 4-5min Settle
- `11-anti-padroes.md` — checklist de auditoria pré-disparo
