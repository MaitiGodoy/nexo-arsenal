---
name: market-emails
description: Sequências completas de e-mail pra URL ou tópico — subject lines, body, timing, segmentação, calibradas em benchmarks de indústria. Trigger: '/market emails <url|topic>' ou 'gera sequência de email'.
---
