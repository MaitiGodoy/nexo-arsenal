---
name: market-funnel
description: Análise de funil de uma URL — mapeia conversion path, identifica drop-offs, quantifica fricção, prioriza otimizações por lift estimado e esforço. Trigger: '/market funnel <url>' ou 'analise o funil desse site'.
---
