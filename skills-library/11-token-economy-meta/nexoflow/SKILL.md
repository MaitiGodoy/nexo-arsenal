...
Quando o ciclo precisar de mais de um subagente rodando em paralelo/pipeline
(não só o par Opus/DeepSeek) — ver `[[super-orchestrator]]` pra decidir a
estratégia certa antes de spawnar.
